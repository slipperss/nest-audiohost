...
export class TracksController {
  ...
  @ApiBody({
    type: UpdateTrackDto,
    required: true,
    description: "Options To Update Track",
  })
  @ApiParam({
    name: "id",
    type: Number,
  ...
  @UseGuards(JwtAuthGuard)
  @Delete(":id")
  async deleteTrack(@Param("id") id: number, @Request() req) {
  ...
  @UseGuards(JwtAuthGuard)
  @Post(":id/like")
  async likeTrack(@Param("id") id: number, @Request() req) {
  ...
  @UseGuards(JwtAuthGuard)
  @Post(":id/unlike")
  async unlikeTrack(@Param("id") id: number, @Request() req) {
  ...
  @UseGuards(JwtAuthGuard)
  @Post(":id/listenings")
  async addTrackListening(@Param("id") id: number, @Request() req) {
