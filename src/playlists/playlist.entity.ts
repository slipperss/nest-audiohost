...
export class Playlist {
  ...
  @ApiProperty({example: "The best tracks of 2022", description: "Track Title"})
  ...
  @JoinTable({name: "playlist-tracks", joinColumn: {name: "playlistId"}, inverseJoinColumn: {name: "trackId"},})
  tracks: Track[]
